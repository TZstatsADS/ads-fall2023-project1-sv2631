...
I started with the original data 'cleaned_hm.csv' that needed to be cleaned and processed before it is ready for analysis. Then, I applied techniques such as lower casing letters, removing punctuations and extra spaces, stemming the words, and making id for each happy moment. This final data  'processed_moments.csv' is stored in the output folder.

I now join this processed text with the demographic data 'demographic.csv' and select a subset of the combined data satisfying specific row conditions.
